            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-surface bg-overlay-xs">
                  {["Client", "Email", "Status", "Monthly Rate", "Active Projects"].map((h) => (
                ...
                {filtered.map((client, i) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-5 py-3.5 text-sm text-muted-app">
                        {client.email ?? "—"}
                      </td>
                      <td className="px-5 py-3.5">
                      ...
                      <td className="px-5 py-3.5 text-sm font-semibold text-primary-app">
