...
import { uploadFileToTask } from "@/lib/db/tasks";
...
export default function TaskDetailClient({ task, initialComments, initialFiles }: TaskDetailClientProps) {
  ...
  return (
    <div className="mx-auto max-w-4xl p-4 sm:p-6 lg:p-10">
      ...
      <div className="flex flex-col gap-8">
        {/* Title + meta */}
        <div className="rounded-2xl border border-surface bg-surface-card p-5 sm:p-7">
          ...
          <h1 className="text-xl sm:text-2xl font-bold tracking-[-0.03em] text-bright leading-tight mb-6">
            {task.title}
          </h1>

          {/* Meta row */}
          <div className="grid grid-cols-2 gap-x-6 gap-y-4 sm:grid-cols-3 border-t border-surface pt-5">
            <div>
        ...
        {/* Comments */}
        <div className="rounded-2xl border border-surface bg-surface-card p-4 sm:p-6">
